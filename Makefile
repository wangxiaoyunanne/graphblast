...
all: gbfs gdiameter gsssp glgc gmis ggc ggc_cusparse gpr gdnn
...
clean:
	rm -f bin/gbfs bin/gdiameter bin/gsssp bin/glgc bin/gmis bin/ggc bin/ggc_cusparse bin/gpr bin/gdnn
